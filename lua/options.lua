...
vim.opt.showmode = false                               -- I need to see things like -- INSERT -- a litte bit
...
vim.opt.whichwrap:append("<,>,[,],h,l") -- to move to the previous/next line on the first/last character in the line
